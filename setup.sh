...
wget  -q https://www.dropbox.com/s/fn0y5w2syz7mnzt/rclone-v1.50.2-linux-amd64-21vianet.zip?dl=1
解压缩-q rclone-v1.50.2-linux-amd64-21vianet.ziprclone-v1.50.2-linux-amd64-21vianet.zip
导出 路径= $ PWD /rclone-v1.51.0-linux-amd64：$ PATH
